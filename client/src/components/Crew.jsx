...
function Crew() {
    ...
    function isCrewSelected(crewRole) {
        return crewRole === selectedCrew
    }
	...
	return (
		<main id="main" className="grid-container grid-container--crew flow">
			...
			<div className="dot-indicators flex">
				<button aria-selected={isCrewSelected('Commander')} className="dot" onClick={() => handleCrewClick('Commander')}>
					<span className="sr-only">Commander</span>
				</button>
				<button aria-selected={isCrewSelected('Mission Specialist')} className="dot" onClick={() => handleCrewClick('Mission Specialist')}>
					<span className="sr-only">Specialist</span>
				</button>
				<button aria-selected={isCrewSelected('Pilot')} className="dot" onClick={() => handleCrewClick('Pilot')}>
					<span className="sr-only">Pilot</span>
				</button>
				<button aria-selected={isCrewSelected('Flight Engineer')} className="dot" onClick={() => handleCrewClick('Flight Engineer')}>
